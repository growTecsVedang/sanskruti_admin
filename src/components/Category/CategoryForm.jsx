  ...
  return (
    <div className="">
      ...
      <div className=" flex w-[full] bg-[#edf2f4] opacity-80 ">
        ...
        <div className=" flex flex-col overflow-y-scroll  min-h-[100vh] w-[100%] lg:w-[80%] no-scroll ">
          <div className="w-[97%] mx-auto mt-5 mb-1 h-[60px] justify-center bg-white  rounded-md flex flex-col     shadow-md ">
            <h1 className="text-black lg:text-3xl text-2xl   pl-4 ">
              Category Form
            </h1>
          </div>
          <div className="w-[97%] mx-auto     min-h-[100vh] bg-white  rounded-md flex flex-col     shadow-md ">
            <form>
