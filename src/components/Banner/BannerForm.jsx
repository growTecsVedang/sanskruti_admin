  ...
  return (
    <main className="overflow-y-auto w-full p-5 overflow-x-hidden h-[89vh]">
      <form
        ...
        className="flex flex-col p-5 gap-6 rounded-md bg-white"
      >
...
export const ReactDropZone = ({
  ...
  return (
    <div className="flex items-center justify-center w-full cursor-pointer ">
      <label
        htmlFor={"dropzone-file" + screenType}
      ...
      >
        ...
        <input
          id={"dropzone-file" + screenType}
          ref={fileInputRef}
          type="file"
          className="hidden"
          onChange={(e) => handleFileChange(e, screenType)}
        />
      </label>
    </div>
  );
